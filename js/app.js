...
function mostrarAlerta(msj){
    const existeAlerta = document.querySelector('.bg-red-00');
...
function buscarImagenes(){
    ...
    const key = '20659903-c5bae6cdcde5e828e9205dce0';
...
function mostrarImagenes(img){
    ...
    while(resultado.firstChild){
        resultado.removeChild(resultado.firstChild);//Borra el html.
    }
...
function imprimirPaginador(){
    ...
    while(true){
        ...
        //Caso contrario, genera un boton x cada pagina
        const boton = document.createElement('a');
        boton.href = '#';
        boton.dataset.pagina = value;
        boton.textContent = value;
        boton.classList.add('siguiente','mx-auto','bg-yellow-400','px-4','py-1','mr-2','font-bold','mb-1',
        'rounded');
